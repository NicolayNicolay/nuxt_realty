<template>
  <header class="bd-header order-1">
      ...
      <div class="header-alert">
        ...
        <div class="container">
          <div class="alert mb-0">
            <div class="h7">
              Здесь каждая минута может быть обращена в удовольствие
            </div>
            <div class="text">
              Преимуществом этих квартир является максимальная площадь остекления, дающая много естественного света, выдающийся панорамный вид и возможность создания собственного микроклимата благодаря система кондиционирования VRV.
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="bd-header-background">
      <img src="/images/page2/main_screen.jpg" alt="" class="d-none d-md-block">
    </div>
    <sales-component />
    <circle-component />
  </header>
...
const menuItems = [
  'О проекте', 'Преимущества', 'Планировки', 'Каталог', 'Выбор квартиры'
]
</script>
